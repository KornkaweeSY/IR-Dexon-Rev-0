<template>
    <footer class="bg-linear-to-b from-gray-900 to-gray-950 text-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 md:px-8 pb-6 sm:pb-8 pt-12 sm:pt-16 md:pt-20 relative z-10">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10 lg:gap-12">
                <!-- Contact Section -->
                    ...
                    <div class="space-y-2 sm:space-y-2.5 md:space-y-3 text-gray-300 text-sm leading-relaxed">
                        ...
                        <div class="pt-2 space-y-1.5 sm:space-y-2 md:space-y-2">
                            ...
                            <p class="flex items-center gap-2 text-xs sm:text-sm">
                                ...
                                <a href="mailto:ir@dexon-technology.com" class="hover:text-blue-400 transition-colors break-all">ir@dexon-technology.com</a>
                            </p>
                            <p class="flex items-center gap-2 text-xs sm:text-sm md:text-sm">
                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4 md:h-4 text-blue-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <ul class="space-y-2 sm:space-y-2.5 md:space-y-3">
                        ...
                        <li>
                            <a href="#features" class="text-sm sm:text-base md:text-base text-gray-400 hover:text-blue-400 transition-all duration-300 flex items-center gap-2 group">
                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4 md:h-4 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                                <span>Resources</span>
                        ...
                        <li>
                            <a href="#about" class="text-sm sm:text-base md:text-base text-gray-400 hover:text-blue-400 transition-all duration-300 flex items-center gap-2 group">
                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4 md:h-4 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="sm:col-span-2 md:col-span-2 lg:col-span-1">
                    ...
                    <div class="space-y-3 sm:space-y-3.5 md:space-y-4">
                        ...
                        <div class="flex gap-2 sm:gap-3 md:gap-3 pt-2">
                            <a href="https://www.facebook.com/Dexontechnology/" target="_blank" rel="noopener noreferrer" class="w-9 h-9 sm:w-10 sm:h-10 md:w-10 md:h-10 bg-blue-500/10 hover:bg-blue-500/20 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 md:w-5 md:h-5 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
                            <a href="https://www.linkedin.com/company/dexon-technology/" target="_blank" rel="noopener noreferrer" class="w-9 h-9 sm:w-10 sm:h-10 md:w-10 md:h-10 bg-blue-500/10 hover:bg-blue-500/20 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 md:w-5 md:h-5 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
